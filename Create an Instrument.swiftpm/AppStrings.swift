...
struct AppStrings {
    ...
    static let onboardingMessages = [
        "Music is present everywhere: in car radio songs, in TV show and game soundtracks and even in orchestras and solo performances. All over the world, for all ages and tastes.",
